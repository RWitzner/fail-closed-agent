...
W4 orchestrator reconcile wiring built (1611 tests); next is W5 (CLI/canary/purity) per contract §J,
then W6 = adversarial review. M1 tier-2 (2b live-verified) stays deferred (no paid
