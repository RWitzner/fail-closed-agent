...
| **M6 — Reconcile hardening** | **DONE** — SOD/EOD broker reconciliation; drift injection; W6 initial review blockers fixed in `483ea34`; separate W6 re-review clean. | S5 (drift flagged, non-zero exit); broker = truth on conflict. |
